  ...
  const initialPosts: Post[] = [
    {
      ...
      likes: 120,
      comments: 15,
      isLiked: false, // Tracking if user liked the post
    },
    {
      id: 2,
      username: "Jane Smith",
      ...
      <div className="container mx-auto space-y-12">
        ...
        <div className="trending-section mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {postList
              .filter((post) => post.likes > 50)  // Example filter for trending posts
              .map((post) => (
                <div key={post.id} className="post-card bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-500">
                  ...
                  <div className="post-actions mt-4 flex justify-between text-sm text-gray-400">
                    <button 
                      className={`like-btn flex items-center ${post.isLiked ? 'text-red-500' : 'hover:text-yellow-400'}`} 
